  ...
  return (
    <div className="absolute inset-0 z-[90] flex flex-col"
      ...
      <div className="overflow-y-auto flex-1 px-5 py-4 text-sm leading-relaxed"
        ...
        <Section title="8. Правила использования">
          Используя приложение RYADOM, вы соглашаетесь соблюдать следующие правила:
          <ul className="list-disc pl-4 flex flex-col gap-1 mt-1">
            <li>Запрещено использовать приложение для преследования, слежки или причинения вреда другим пользователям</li>
            <li>Запрещено создавать события с целью введения в заблуждение или мошенничества</li>
            <li>Запрещено публиковать оскорбительный, угрожающий или незаконный контент</li>
            <li>Запрещено использовать чужие данные без согласия</li>
            <li>Пользователь несёт личную ответственность за безопасность при участии в событиях</li>
            <li>Рекомендуем встречаться в общественных местах и сообщать близким о своих планах</li>
          </ul>
          Нарушение правил влечёт блокировку аккаунта. О нарушениях сообщайте через кнопку «Пожаловаться» в приложении.
        </Section>
